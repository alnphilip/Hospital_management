                ...
                {recentAppointments.length === 0 ? (
                    ...
                    <div className="flex flex-col gap-4">
                        {recentAppointments.map((apt) => (
                            <div key={apt.id} className="flex flex-col sm:flex-row sm:items-center gap-4 sm:justify-between p-6 rounded-[2rem] glass-panel border border-white/10 transition-all hover:scale-[1.01] hover:shadow-2xl">
                                {/* Left: Subject & Status */}
